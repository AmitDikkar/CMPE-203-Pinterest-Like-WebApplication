...
/**
  Class: Extractor controller for handling image/video extractor
* @author Anup
*/
class Extractor extends CI_Controller {
    ...
    /**
     * Function to load the extractor page with images extracted from the site.
     * @param   : 
     * @author  : Anup 
     * @return
     */
    ...
    /**
     * Function to get the image which is to be saved. 
     * @author  : Anup 
     * @return
     */
    ...
    function submit()
    {
        ...
        //ownload and save the new image to the user folder and use it as pin url.
        if($value['type']=='image')

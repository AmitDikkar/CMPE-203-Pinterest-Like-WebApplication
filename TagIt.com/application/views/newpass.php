    ...
    <div class="FixedContainer">
            <?php if($success==1):?>
                <div class="alert_messgae">
                    <h2>Password reset successfully..<a href="/ci/pinterest/login/handleLogin">Click <span class="error">here</span> to login</a></h2>
                </div>
            <?php else:?>
                <?php if($emailcheck==1):?>
            ...
            <?php else:?>
            <div class="alert_messgae">
                <span><h2>Your email id is invalid</h2></span>
            </div>
        <?php endif?>
    <?php endif?>
</div>

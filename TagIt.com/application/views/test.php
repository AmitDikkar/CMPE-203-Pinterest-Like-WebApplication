...
<link href="<?php echo base_url(); ?>application/ui/css/popup.css" rel="stylesheet" type="text/css" />
...
<!--            <div class="PinActionButtons-box">
                ...
                <div style="float:right;">
                        <ul class="social_right">
                            <li><a href="http://twitter.com/share" class="twitter-share-button" data-count="none" data-size="large" data-via="TagIt" data-text="<?php echo $pinDetails->description; ?>"> </a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></li>
                            <li><a title="Share this article/post/whatever on Facebook" href="http://www.facebook.com/sharer.php?s=100&p[url]=<?php echo current_url();?>&p[images][0]=<?php echo $pinDetails->pin_url;?>&p[title]=<?php echo $pinDetails->description;?>&p[summary]=<?php echo " ";?>"target="_blank"><img src="<?php echo site_url('application/ui/images/facebook_button.png')?>" width='75px' height='27px'/></a></li>
                        </ul>
                </div>
            <div class="clear"></div>
            <?php endif;?>
            <div class="clear"></div>
            <div id="loading_gif" style="display: none"><img src="<?php echo site_url('application/ui/images/loading.gif');?>" width="75px" height="75px;"/></div>

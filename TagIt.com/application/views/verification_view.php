    ...
    <div class="header"><!-- starting Header -->
        <div class="container"><!-- starting container -->
            <div class="header_box">
                <div class="logo"><a href="<?php echo site_url();?>"><img src="<?php echo site_url()?>/application/ui/images/tagit/logo.png"/></a></div>
            </div>
        ...
        <div class="container"><!-- staing container -->
            <div class="alert_messgae">
             <?php if(isset($success)):?>
                <h2>Registration Successful<a href="<?php echo site_url('login');?>"><span class="error">HERE</span></a></h2>
            <?php elseif(isset($failed)):?>
                <h2>Verification Failed </h2>
            <?php elseif(isset($cookie_messsage)):?>
                <h2>SORRY SOMETHING WENT WRONG</h2>
            <?php else:?>
                    <h2>YOU HAVE SUCCESSFULLY REGISTERED . YOU CAN LOGIN <a href="<?php echo site_url('login');?>"><strong><span >HERE</span></strong></a></h2>

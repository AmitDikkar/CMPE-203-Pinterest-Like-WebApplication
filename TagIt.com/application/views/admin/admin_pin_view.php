                                ...
                                <tbody>
                                    <?php foreach ($result as $key => $value):?>
                                        <tr id="tr_<?php echo $value->id;?>">
                                            ...
                                            <td id="edit_<?php echo $value->id;?>"><a href="<?php echo site_url('administrator/editPin/'.$value->id);?>" rel="facebox"><img src="<?php echo site_url('application/ui/images/admin/edit.png');?>"/></a></td>
                                            <td id="remove_<?php echo $value->id;?>"><a href="<?php echo site_url('administrator/confirmDeletePin/'.$value->id);?>" rel="facebox"><img src="<?php echo site_url('application/ui/images/admin/delete.png');?>"/></a></td>
                                        </tr>
                                    <?php endforeach;?>
                                </tbody>

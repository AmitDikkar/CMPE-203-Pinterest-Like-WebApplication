                                ...
                                <tbody>
                                    <?php foreach ($result as $key => $value):?>
                                        <tr id="tr_<?php echo $value->pin_id;?>">
                                            ...
                                            <td id="remove_<?php echo $value->pin_id;?>"><a href="<?php echo site_url('administrator/confirmDeletePin/'.$value->pin_id);?>" rel="facebox"><img src="<?php echo site_url('application/ui/images/admin/delete.png');?>"/></a></td>
                                        </tr>
                                    <?php endforeach;?>
                                </tbody>
